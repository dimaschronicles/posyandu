                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <ul class="list-group">
                                    <li class="list-group-item"><?= $balita['tanggal_lahir']; ?></li>
                                </ul>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <ul class="list-group">
                                    <li class="list-group-item"><?= $balita['jenis_kelamin']; ?></li>
                                </ul>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <ul class="list-group">
                                    <li class="list-group-item"><?= $balita['alamat']; ?></li>
                                </ul>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <ul class="list-group">
                                    <li class="list-group-item"><?= $balita['panjang_badan']; ?></li>
                                </ul>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <ul class="list-group">
                                    <li class="list-group-item"><?= $balita['berat_lahir']; ?></li>
                                </ul>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <ul class="list-group">
                                    <li class="list-group-item"><?= $balita['lingkar_kepala']; ?></li>
                                </ul>
                            </div>
                        </div>
                        <div class="row mb-3">
