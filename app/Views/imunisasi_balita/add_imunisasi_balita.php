        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="/imunisasibalita" method="POST">
                            <?= csrf_field(); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="tanggal_imunisasi" name="tanggal_imunisasi" value="<?= old('tanggal_imunisasi'); ?>">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select <?= ($validation->hasError('id_imunisasi')) ? 'is-invalid' : ''; ?>" id="id_imunisasi" name="id_imunisasi">
                                        ...
                                        <?php foreach ($imunisasi as $i) : ?>
                                            <option value="<?= $i['id_imunisasi']; ?>" <?= (old('id_imunisasi') == $i['id_imunisasi']) ? 'selected' : ''; ?>><?= $i['nama_imunisasi']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control <?= ($validation->hasError('keterangan_imunisasi')) ? 'is-invalid' : ''; ?>" id="keterangan_imunisasi" name="keterangan_imunisasi" rows="3"><?= old('keterangan_imunisasi'); ?></textarea>
                                    <div class="invalid-feedback">
