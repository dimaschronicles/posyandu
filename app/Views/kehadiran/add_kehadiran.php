                    ...
                    <div class="card-body">
                        <form action="/kehadiran" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control <?= ($validation->hasError('tanggal')) ? 'is-invalid' : ''; ?>" name="tanggal" id="tanggal" value="<?= old('tanggal'); ?>">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select <?= ($validation->hasError('id_balita')) ? 'is-invalid' : ''; ?>" name="id_balita" id="id_balita">
                                        ...
                                        <?php foreach ($balita as $b) : ?>
                                            <option value="<?= $b['id_balita']; ?>" <?= (old('id_balita') == $b['id_balita']) ? 'selected' : ''; ?>><?= $b['nama_balita']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control <?= ($validation->hasError('nama_pengantar')) ? 'is-invalid' : ''; ?>" name="nama_pengantar" id="nama_pengantar" value="<?= old('nama_pengantar'); ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control <?= ($validation->hasError('hub_keluarga')) ? 'is-invalid' : ''; ?>" name="hub_keluarga" id="hub_keluarga" value="<?= old('hub_keluarga'); ?>" placeholder="Contoh : Nenek">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check">
                                        <input class="form-check-input  <?= ($validation->hasError('keterangan')) ? 'is-invalid' : ''; ?>" type="radio" name="keterangan" id="keterangan" value="Hadir" <?= (old('keterangan') == 'Hadir') ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="keterangan1">Hadir</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input  <?= ($validation->hasError('keterangan')) ? 'is-invalid' : ''; ?>" type="radio" name="keterangan" id="keterangan" value="Tidak Hadir" <?= (old('keterangan') == 'Tidak Hadir') ? 'checked' : ''; ?>>
